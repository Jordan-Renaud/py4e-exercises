...
Actual data: http://py4e-data.dr-chuck.net/regex_sum_945158.txt (There are 91
values and the sum ends with 661)
...
file_handler = set_file_handler("regex_sum_945158.txt")
list_of_numbers = []
total = 0
count = 0
...
for line in file_handler:
    ...
    if len(re.findall("[0-9]", line)) > 0 :
        list_of_numbers.append(re.findall("[0-9]+", line))


for section in list_of_numbers:
    for num in section:
        total += int(num)
